...
var P = (n, t = true, e) => {
  var k, g, b, d;
  const s = ((k = e.number) == null ? void 0 : k.unsigned) !== true && n.startsWith("-") ? "-" : "", r = ((g = e.number) == null ? void 0 : g.fraction) ?? 0;
  let a = w(0, r, e);
...
var O = class {
  ...
  process(t, e, s = true) {
    ...
    let b, d = -1, o = this.isReversed() ? a.length - 1 : 0, c = this.isReversed() ? t.length - 1 : 0, M = false;
    for (; k(); ) {
      const v = a.charAt(o), m = f[v], y = (m == null ? void 0 : m.transform) != null ? m.transform(t.charAt(c)) : t.charAt(c);
      if (!u.includes(o) && m != null ? (y.match(m.pattern) != null ? (p[h](y), m.repeated ? (d === -1 ? d = o : o === l && o !== d && (o = d - i), l === d && (o -= i)) : m.multiple && (M = true, o -= i), o += i) : m.multiple ? M && (o += i, c -= i, M = false) : y === b ? b = void 0 : m.optional && (o += i, c -= i), c += i) : (s && !this.isEager() && p[h](v), y === v && !this.isEager() ? c += i : b = v, this.isEager() || (o += i)), this.isEager())
...
//# sourceMappingURL=chunk-ZYZZM5RG.js.map
